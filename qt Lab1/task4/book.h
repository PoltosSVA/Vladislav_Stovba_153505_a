...
public:
    ...
    Book (QString strin);
    ~Book();
    Book(int pages,int y_publish,QString name,QString ser_name,QString second_name,QString publishing,QString book_title);
    QString toStr_name();
    QString toStr_publishing();
    QString toStr_book_title();
    QString toStr_pages();
    QString toStr_y_publish();
public:
