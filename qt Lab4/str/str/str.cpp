...
public:
	...
	bool operator==(const _string& st)
	{
...
int main() {
	...
	_string a= "The quick brown fox jumps over a lazy dog.";
	_string b= "12345678";
	_string str3("sample phrase");
	_string c("1234567810");
	_string str1 = "123456789";
		
	_string str2 = "n example";
		
	_string base = "this is a test string.";
	_string str = base;
