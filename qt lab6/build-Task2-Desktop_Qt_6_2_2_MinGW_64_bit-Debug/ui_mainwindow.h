...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tableView->setGeometry(QRect(10, 10, 400, 300));
        tableView->horizontalHeader()->setDefaultSectionSize(390);
        layoutWidget = new QWidget(centralwidget);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(440, 100, 162, 147));
        ...
        textEdit->setGeometry(QRect(10, 320, 401, 31));
        MainWindow->setCentralWidget(centralwidget);
        menubar = new QMenuBar(MainWindow);
        menubar->setObjectName(QString::fromUtf8("menubar"));
        menubar->setGeometry(QRect(0, 0, 622, 26));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_4->setText(QCoreApplication::translate("MainWindow", "Ind", nullptr));
    } // retranslateUi
